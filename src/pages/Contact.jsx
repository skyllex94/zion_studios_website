          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                Zion Studios is a full-service digital agency focused on helping small businesses and contractors grow their online presence. We build professional websites designed to convert visitors into leads, complete with SEO optimization, booking systems, and lead management tools.
              </p>
              <p className="text-gray-600 mb-8 leading-relaxed">
                We also develop innovative iOS applications for productivity, security, and daily life. Our mobile apps have helped over 10,000 users worldwide.
              </p>
